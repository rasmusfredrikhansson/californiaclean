  ...
  return (
    <footer>
      <div className="footer">
        ...
        <div className="footer-logo" onClick={() => scroll.scrollToTop()}><img src={footer_logo} />
          <br/>
        </div>
        ...
        <ul className="contact">
          ...
          <li>167 37 Bromma</li>
          <li style={{marginTop: '0px'}}><i className="fas fa-phone-alt"></i><a href="tel:0728692123"><strong style={{ fontSize: '19px'}}>072-869 21 23</strong></a></li>
          ...
          <li>{t('FooterServices.11')}</li>
          <li style={{marginTop: '10px'}}>© <strong>2021 California Clean</strong></li>
        </ul>
        <div className="spacer"></div>
      </div>
    </footer> 
